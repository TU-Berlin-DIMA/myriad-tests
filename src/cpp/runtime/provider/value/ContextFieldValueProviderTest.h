...
public:
    ...
    void testValueProviderFunctor()
    {
        ...
        for (int i = 0; i < 1000; i++)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                CPPUNIT_ASSERT_EQUAL_MESSAGE("Values don't match", x, mockField1ValueProvider(mockCxtRecordPtr, randomStream));
            }
        }
        ...
        for (int i = 0; i < 1000; i++)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                CPPUNIT_ASSERT_EQUAL_MESSAGE("Values don't match", x, mockField2ValueProvider(mockCxtRecordPtr, randomStream));
            }
        }
        ...
        for (int i = 0; i < 1000; i++)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                CPPUNIT_ASSERT_EQUAL_MESSAGE("Values don't match", x, mockField3ValueProvider(mockCxtRecordPtr, randomStream));
            }
        }
    }
    ...
    void testFieldValueRange()
    {
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            CPPUNIT_ASSERT_THROW_MESSAGE("valueRange() is not supported", mockField2ValueProvider.valueRange(x, mockCxtRecordPtr), RuntimeException);
            CPPUNIT_ASSERT_THROW_MESSAGE("valueRange() is not supported", mockField2ValueProvider.valueRange(y, mockCxtRecordPtr), RuntimeException);
        }
    }
    ...
    void testFieldSetterInstance()
    {
        ...
        for (int i = 0; i < 1000; i++)
        {
            ...
            {
                mockCxtRecordPtr->mockField1(x);
                mockField4Setter(mockCxtRecordPtr, randomStream);
